...
def draw_boxes(img, boxes, category_ids=None, cats=None, scores=None, tags=None, line_thick=1, line_color='white', vis=False):
...
def draw_boxes_bbox_with_dtandgt_hm(img, boxes, category_ids=None, cats=None, scores=None, tags=None, line_thick=2, line_color='white', vis=False):
    ...
    for i in range(len(boxes)):
        ...
        cv2.putText(img, "gt", (x1, y1 - 7), cv2.FONT_ITALIC, 0.2, color[line_color], 1)
    return img


def draw_boxes_bbox_with_hm(img, boxes, category_ids=None, cats=None, scores=None, tags=None, line_thick=2, line_color='white', vis=False):
    ...
    for i in range(len(boxes)):
        ...
        if category_ids is not None and not vis:
            ...
            text = "{}".format(tag)
            cv2.putText(img, text, (x1, y1 - 7), cv2.FONT_ITALIC, 0.5, color[line_color], 1)
        cv2.putText(img, "%.2f"%score, (x1, y1 - 7), cv2.FONT_ITALIC, 0.2, color[line_color], 1)
    return img
