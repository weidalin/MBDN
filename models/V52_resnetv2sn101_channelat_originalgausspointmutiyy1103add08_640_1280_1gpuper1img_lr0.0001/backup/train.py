...
version = 'V52_%s_channelat_originalgausspointmutiyy1103add08_%d_%d_%dgpuper%dimg_lr%s'%(net.resnetType, config.size_train[0], config.size_train[1],len(config.gpu_ids),config.onegpu,config.init_lr)
# To continue training
resume_from = ''
# resume_from = './models/%s/ckpt/ACSP_69.pth.tea'%version
resume_from = './models/V52_resnetv2sn101_channelat_originalgausspointmutiyy1103add08_640_1280_1gpuper1img_lr0.0001/ckpt/ACSP_49.pth.tea'
begin_epoch_num = 0
