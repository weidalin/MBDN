...
class ACSPNet(nn.Module):
    def __init__(self):
        ...
        self.pos_conv = nn.Conv2d(256, 2, kernel_size=1)  # (256, 1, kernel_size=1) --> (256, 3, kernel_size=1)
    ...
    def forward(self, x):#torch.Size([1, 3, 640, 1280])
        ...
        # x_cls1, x_reg1, x_off1 =  self.brand1(cat) #x_cls1:torch.Size([2, 1, 160, 320])
        # x_cls2, x_reg2, x_off2 =  self.brand2(cat)
        feat = self.feat(cat)
