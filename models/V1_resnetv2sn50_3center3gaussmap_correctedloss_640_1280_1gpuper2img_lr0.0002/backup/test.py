...
def val(r, name, log=None):
    ...
    for i, data in enumerate(testloader, 0):
        ...
        with torch.no_grad():
            pos, height, offset = net(inputs)#test:torch.Size([1, 1, 256, 512]) torch.Size([1, 1, 256, 512]) torch.Size([1, 2, 256, 512]) input:torch.Size([1, 3, 1024, 2048])
...
version = 'V1_resnetv2sn50_3center3gaussmap_correctedloss_640_1280_1gpuper2img_lr0.0002'
